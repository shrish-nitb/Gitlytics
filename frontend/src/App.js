...
export function App() {
  ...
  const [showResults, setShowResults] = useState(
    "Please write your Github profile URL(github.com/<username> or https://github.com/<username>) and Hit Enter"
  );
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.request({
        url: `https://githubviewer.onrender.com/github-info?username=${(UserName.toLowerCase().split("/"))[UserName.split("/").indexOf('github.com')+1]}`,
      });
